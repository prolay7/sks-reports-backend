    ...
    <div class="row">
      ...
      <div class="col-12">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link @if(Request::segment(1) == 'submit') active @endif"  href="{{route('submit')}}">Application Status</a>
            </li>
        </ul>
        <div class="darkBox p-4 pb-2">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane container @if(Request::segment(1) == 'education-details') active @endif" id="education">
                    ...
                    <form action="{{ route('save-education-details')}}" method="post" enctype="multipart/form-data" class="needs-validation @if ($errors->any()) was-validated @endif" novalidate>
                        @csrf
                ...
                <div class="tab-pane container @if(Request::segment(1) == 'acknowledge-details') active @endif" id="acknowledgement">
                    <form action="{{ route('save-acknowledge-details')}}" method="post" class="needs-validation @if ($errors->any()) was-validated @endif" novalidate>
                        @csrf
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="acknowledge" value="1" id="flexCheckDefault" required="required">
                ...
                <div class="tab-pane container @if(Request::segment(1) == 'submit') active @endif" id="submit">
                    
                    <div class="row">
                        
                        <div class="col-lg-12">
                            <center>
                                <img src="{{asset('assets/frontend/onboarding/img/right-sign.png')}}" style="width:250px;">
                                <br>
                                <br>
                                ...
                                <br>
                                <p>
                                    For your record , you have successfully submitted your application form. We have sent one confirmation mail to your registered email for future reference 
                                </p>
                            </center>
                        </div>
                    </div>
                            ...
                            <center>
                                ...
                                <div class="form-group  pb-sm">
                                    ...
                                    <button type="button" class="btn btn-primary menu menu-big"
                                      id="lead_callregister">Track Your Application</button>
                                  </div>
                            </center>
                        </div>
                    </div>
