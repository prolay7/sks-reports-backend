    ...
    <div class="loginWrap ">
        ...
        <div class="d-flex loginSide">
            <div class="logincon">
                ...
                <div class="loginBox">
                    <h2>Employee Onbarding</h2>
                    <p class="text-white">Register with  Sikshapedia  </p>
                    @include('backend.flash-message.flash-message')	
                    <form action="{{ route('onboarding') }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-gorup mb-3">
                                <input type="text" id="name" name="name" class="form-control loginField" placeholder="Enter name" value="{{ old('name') }}" required>
                        ...
                        <div class="form-gorup mb-3">
                            <input type="email" id="email" name="email" class="form-control loginField" placeholder="Enter Email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-gorup mb-3">
                            <input type="number" id="mobile" required="required" name="mobile" class="form-control loginField" placeholder="10 digit mobile number">
                            <div class="invalid-feedback" style="color:white;">
                        ...
                        <div class="d-flex flex-md-row flex-sm-column justify-content-between align-items-center">
                            <div>
                                <button class="btn btn-primary loginBtn" type="submit" id="emp_login">Submit</button>
                            </div>
