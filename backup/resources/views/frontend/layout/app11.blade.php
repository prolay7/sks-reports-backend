...
<head>
	...
	@include('backend._partials.header-style')
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
		...
		@include('backend._partials.chat-box')
        ...
        @include('backend._partials.add-employee')
		
        @include('backend._partials.add-new-task')
        ...
        ***********************************-->
        <!--<div class="footer">
            <div class="copyright">
               <p>Copyright © Developed by <a href="https://ncriptech.com/" target="_blank">ncriptech</a> 2023</p>
            </div>
        </div>-->
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    @include('backend._partials.footer-script')
