...
@section('title','Edit User Role | ncriptech website CMS')
			...
			<div class="container-fluid">
				<div class="row">
					<div class="d-flex align-items-center justify-content-between">
						<h4 class="heading mb-3">Update User Role</h4>
					</div>
														...
														<td>
															<div class="action-button">
                                                                ...
                                                                @php($id = encrypt($rolwlist->id))
																	...
																	document.getElementById('role-delete').submit(); }else{}" href="#" class="btn btn-danger btn-icon-xxs"><i class="fas fa-trash-alt"></i></a>
																	<form id="role-delete" action="{{ route('roles.destroy',$id)}}" method="DELETE">
																		@csrf
																	</form>
																@endcan
															</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="row">
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header py-3">
										<h4 class="heading mb-0">Update Roles</h4>
									</div>
									<div class="card-body">
                                        
										<div class="basic-form">
											<form action="{{ route('admin.updateUserRole') }}" method="post" class="needs-validation" novalidate>
												@csrf
												...
												<div class="mb-3">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control" name="name" id="validationCustomUsername" value="{{$role['name']}}" placeholder="Enter a rolename.." required>
																...
																<tr>
																	...
																	<td>
																		@if(isset($check_view[0]))
																			<div class="form-check custom-checkbox mb-3">
																				<input type="checkbox" name="permission[]" class="form-check-input" id="customCheckBox1" value="{{$check_view[0]->id}}" {{ in_array($check_view[0]->id, $rolePermissions) ? 'checked' : '' }}>
																	...
																	<td>
																		@if(isset($check_list[0]))
																			<div class="form-check custom-checkbox mb-3">
																				<input type="checkbox" name="permission[]" class="form-check-input" id="customCheckBox1" value="{{$check_list[0]->id}}" {{ in_array($check_list[0]->id, $rolePermissions) ? 'checked' : '' }}>
																	...
																	<td>
																		@if(isset($check_create[0]))
																			<div class="form-check custom-checkbox mb-3">
																				<input type="checkbox" name="permission[]" class="form-check-input" id="customCheckBox1" value="{{$check_create[0]->id}}" {{ in_array($check_create[0]->id, $rolePermissions) ? 'checked' : '' }}>
																	...
																	<td>
																		@if(isset($check_edit[0]))
																			<div class="form-check custom-checkbox mb-3">
																				<input type="checkbox" name="permission[]" class="form-check-input" id="customCheckBox1" value="{{$check_edit[0]->id}}" {{ in_array($check_edit[0]->id, $rolePermissions) ? 'checked' : '' }}>
																	...
																	<td>
																		@if(isset($check_delete[0]))
																			<div class="form-check custom-checkbox mb-3">
																				<input type="checkbox" name="permission[]" class="form-check-input" id="customCheckBox1" value="{{$check_delete[0]->id}}" {{ in_array($check_delete[0]->id, $rolePermissions) ? 'checked' : '' }}>
