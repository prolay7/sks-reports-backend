...
<div class="row">
    ...
    <div class="col-lg-3">
        <div class="form-group pb-3">
            <input required="required" id="installment_no_1" name="installment_no_1" type="text"
    ...
    <div class="col-lg-3">
        <div class="form-group pb-3">
            ...
            <input required="required" id="installment_cost_1" name="installment_cost_1" type="text"
    ...
    <div class="col-lg-3">
        <div class="form-group pb-3">
            ...
            <input required="required" id="installment_terms_1" name="installment_terms_1" type="text"
