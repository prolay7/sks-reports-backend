    ...
    <div class="col">
      ...
      @endif
        ...
        <div class="card-body">
          ...
          <button type="button" class="w-100 btn btn-lg btn-warning">EDIT</button>
          <br>
          <br>

          <button type="button" class="w-100 btn btn-lg btn-danger">DELETE</button>

          @elseif(strtoupper($prod->product_name) == 'PREMIUM')
          <button type="button" class="w-100 btn btn-lg btn-primary">EDIT</button>
          <br>
          <br>
