...
@section('title','Edit Employee | sikshapedia HRM Management')
			...
			<div class="d-flex flex-md-row flex-sm-column  justify-content-md-between pb-4 ">
				...
				<div class="row">
					<div class="d-flex justify-content-between align-items-center mb-4">
						<h4 class="heading mb-0">Edit <span> Employee</h4>
						<div class="d-flex align-items-center">
							
							<a href="{{route('users.list')}}" class="btn btn-primary menu menu-big">View Employee List</a>
						</div>
					</div>
											...
											<form action="{{ route('users.update', encrypt($user->id) ) }}" method="post" class="needs-validation" novalidate>
												...
												<div class="mb-3">
													...
													<div class="input-group">
														<input type="text" class="form-control" name="name" id="validationCustomUsername" value="{{$user->name}}" placeholder="Enter a name.." required>
												...
												<div class="mb-3">
													...
													<div class="input-group">
														<input type="email" class="form-control" name="email" id="validationCustomUsername" value="{{$user->email}}" placeholder="Enter  email id." required>
														<div class="invalid-feedback">
															Please Enter Email.
														  </div>
													</div>
                                                ...
                                                <div class="mb-3">
													...
													<div class="input-group">
														<input type="password" class="form-control" name="password" id="validationCustomUsername" placeholder="Enter password.">
														<div class="invalid-feedback">
													...
													<div class="input-group transparent-append">
														...
														<select class="form-control" name="roles"  required>
                                                            ...
                                                            @foreach($roles as $rolename)
															    <option value="{{$rolename->name}}" @if(in_array($rolename->name,$userRole)) selected @endif>{{$rolename->name}}</option>
                                                            @endforeach
