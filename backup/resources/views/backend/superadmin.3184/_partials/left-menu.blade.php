		...
		<li class="list-group-item mb-1">
			...
			<div class="collapse" id="dashboard-collapse" style="padding-left: 40px ;">
			  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small text-white" style="padding:5px;">
				<li style="border:0px;padding:4px;"><a href="#" class="link-white rounded"><img src="{{asset('assets/assets/img/anchor-icon.png')}}" style="width:15px;" alt="">Calling Reports</a></li>
				<li style="border:0px;padding:4px;"><a href="#" class="link-white rounded"><img src="{{asset('assets/assets/img/anchor-icon.png')}}" style="width:15px;" alt="">Appointment Reports</a></li>
				<li style="border:0px;padding:4px;"><a href="#" class="link-white rounded"><img src="{{asset('assets/assets/img/anchor-icon.png')}}" style="width:15px;" alt="">Visit Report</a></li>
				<li style="border:0px;padding:4px;"><a href="#" class="link-white rounded"><img src="{{asset('assets/assets/img/anchor-icon.png')}}" style="width:15px;" alt="">Proposal Send Report</a></li>
