...
@section('title','Calling Reports | sikshapedia Sales Portal')
@section('content')
<div class="mainCon">
    ...
    <div class="d-flex flex-md-row flex-sm-column sm-col justify-content-md-between pb-4">
      <h2 class="heading blue-text">Details Calling Reports</h2>
    ...
    <div class="col-12">
      <h2 class="heading blue-text py-3">Calling List</h2>
        ...
        <table class="table table-bordered tableDark">
          <thead>
            <tr>
              ...
              <th scope="col"  class="text-center">Calling By</th>
...
<script>
  ...
  function get_details_report(){
    ...
    $.ajaxSetup({
		...
		$.ajax({
		  url: "{{ route('reports.details.list') }}",
		  type: 'POST',
		  data: {
			userrole: $("#category").val(),
      userid:$("#user_id").val(),
