...
<div class="mainCon">
    ...
    <div class="d-flex flex-md-row flex-sm-column sm-col justify-content-md-between pb-4">
      <h2 class="heading blue-text">Details Visiting Reports</h2>
    ...
    <div class="col-12">
      <h2 class="heading blue-text py-3">Details Visiting Reports</h2>
      ...
      <div class="table-responsive">
        <table class="table table-bordered tableDark">
          ...
          <tbody id="view_reports">
            ...
            <tr><td colspan="11" class="text-center">No information available</td></tr>
...
<script>
  ...
  function get_details_report(){
    ...
    $.ajaxSetup({
		...
		$.ajax({
		  url: "{{ route('reports.visitingreport.list') }}",
		  type: 'POST',
		  data: {
			userrole: $("#category").val(),
      userid:$("#user_id").val(),
