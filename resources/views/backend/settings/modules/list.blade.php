							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header py-3">
										<h4 class="heading mb-0">Add System Modules</h4>
									</div>
									<div class="card-body">
										<div class="basic-form">
											<form action="{{ route('store-system-module') }}" method="post" class="needs-validation" novalidate>
												@csrf
												<div class="mb-3">
													<label class="text-label form-label" for="validationCustomUsername">Modules Name*</label>
													<div class="input-group">
														<input type="text" class="form-control" name="modules_name" id="validationCustomUsername" placeholder="Enter a module name.." required>
												...
												<div class="mb-3">
													...
													<div class="input-group">
														<input type="text" class="form-control" name="modules_url" id="validationCustomUsername" placeholder="Enter a module url.." required>
														<div class="invalid-feedback">
												...
												<div class="mb-3">
													...
													<div class="input-group">
														<div class="form-check custom-checkbox mb-3 col-md-6">
															<input type="checkbox" name="permission_name[]" class="form-check-input" id="customCheckBox1" value="manage" checked="checked">
															<label class="form-check-label" for="customCheckBox1">Manage</label>
														</div>
														<div class="form-check custom-checkbox mb-3 col-md-6">
															<input type="checkbox" name="permission_name[]" class="form-check-input" id="customCheckBox1" value="view" checked="checked">
															<label class="form-check-label" for="customCheckBox1">View</label>
														</div>
														<div class="form-check custom-checkbox mb-3 col-md-6">
															<input type="checkbox" name="permission_name[]" class="form-check-input" id="customCheckBox1" value="create" checked="checked">
															<label class="form-check-label" for="customCheckBox1">Create</label>
														</div>
														<div class="form-check custom-checkbox mb-3 col-md-6">
															<input type="checkbox" name="permission_name[]" class="form-check-input" id="customCheckBox1" value="edit" checked="checked">
															<label class="form-check-label" for="customCheckBox1">Edit</label>
														</div>
														<div class="form-check custom-checkbox mb-3 col-md-6">
															<input type="checkbox" name="permission_name[]" class="form-check-input" id="customCheckBox1" value="delete" checked="checked">
															<label class="form-check-label" for="customCheckBox1">Delete</label>
														</div>
														<div class="form-check custom-checkbox mb-3 col-md-6">
															<input type="checkbox" name="permission_name[]" class="form-check-input" id="customCheckBox1" value="list" checked="checked">
